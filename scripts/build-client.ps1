...
pyinstaller --clean --noconfirm --onefile --windowed --name client-onedir --hidden-import win32serviceutil --hidden-import win32service --hidden-import win32event --hidden-import servicemanager client.py
