...
def set_network_config(honeypot_ip: Optional[str] = None, tunnel_port: Optional[int] = None, recv_size: Optional[int] = None, 
                      connect_timeout: Optional[int] = None, server_name: Optional[str] = None) -> None:
