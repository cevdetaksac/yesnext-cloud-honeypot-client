...
a = Analysis(
    ...
    pathex=[],
    binaries=[],
    datas=[('certs/*.ico', 'certs'), ('certs/*.png', 'certs'), ('certs/*.bmp', 'certs'), ('client_config.json', '.'), ('client_lang.json', '.'), ('client_memory_restart.py', '.'), ('client_daemon_ipc.py', '.'), ('client_lifecycle.py', '.'), ('client_update_ui.py', '.'), ('client_winproc.py', '.'), ('client_remote_session.py', '.'), ('memory_restart.ps1', '.'), ('scripts/kill-honeypot.ps1', 'scripts'), ('scripts/update-and-install.ps1', 'scripts'), ('client_gui.py', '.'), ('client_gui_lock.py', '.'), ('client_logon_challenge.py', '.'), ('client_eventlog.py', '.'), ('client_threat_engine.py', '.'), ('client_alerts.py', '.'), ('client_auto_response.py', '.'), ('client_remote_commands.py', '.'), ('client_silent_hours.py', '.'), ('client_ransomware_shield.py', '.'), ('client_system_health.py', '.'), ('client_self_protection.py', '.'), ('client_performance.py', '.'), (os.path.join(ctk_path, 'assets'), 'customtkinter/assets')] + _certifi_datas,
    hiddenimports=['client_memory_restart', 'client_daemon_ipc', 'client_lifecycle', 'client_update_ui', 'client_winproc', 'client_remote_session', 'client_honeypots', 'client_service_manager', 'client_gui', 'client_gui_lock', 'client_logon_challenge', 'client_eventlog', 'client_threat_engine', 'client_alerts', 'client_auto_response', 'client_remote_commands', 'client_remote_desktop', 'client_silent_hours', 'client_ransomware_shield', 'client_system_health', 'client_self_protection', 'client_performance', 'customtkinter', 'darkdetect', 'paramiko', 'psutil', 'websocket', 'websocket.websocket', 'win32event', 'win32api', 'winerror', 'win32security', 'ntsecuritycon', 'certifi'],
    hookspath=[],
    hooksconfig={},
