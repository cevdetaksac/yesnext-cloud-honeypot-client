...
a = Analysis(
    ...
    pathex=[],
    binaries=[],
    datas=[('certs/*.ico', 'certs'), ('certs/*.png', 'certs'), ('certs/*.bmp', 'certs'), ('client_config.json', '.'), ('client_lang.json', '.'), ('client_memory_restart.py', '.'), ('client_daemon_ipc.py', '.'), ('client_lifecycle.py', '.'), ('client_update_ui.py', '.'), ('client_winproc.py', '.'), ('client_remote_session.py', '.'), ('memory_restart.ps1', '.'), ('scripts/kill-honeypot.ps1', 'scripts'), ('scripts/update-and-install.ps1', 'scripts'), ('client_gui.py', '.'), ('client_gui_lock.py', '.'), ('client_uninstall_gate.py', '.'), ('client_logon_challenge.py', '.'), ('client_eventlog.py', '.'), ('client_threat_engine.py', '.'), ('client_alerts.py', '.'), ('client_auto_response.py', '.'), ('client_remote_commands.py', '.'), ('client_silent_hours.py', '.'), ('client_ransomware_shield.py', '.'), ('client_system_health.py', '.'), ('client_self_protection.py', '.'), ('client_performance.py', '.'), ('client_guardian_service.py', '.'), ('client_operator_stop.py', '.'), ('client_tamper.py', '.'), ('client_autologon.py', '.'), ('client_network_guard.py', '.'), ('client_server_management.py', '.'), (os.path.join(ctk_path, 'assets'), 'customtkinter/assets')] + _certifi_datas,
